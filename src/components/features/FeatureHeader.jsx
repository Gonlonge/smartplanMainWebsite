...
// // // export default function FeatureHeader({ icon: Icon, docId, slug }) {
// // //     // Header-only fields
...
// // // ⬅️ Use your features array of icons
// // import { features } from "../../data/features";

// // // --- slug → icon resolution using your features[] array ---

// // // Normalize slug (handles diacritics and whitespace)
// // const norm = (s = "") =>
// //     s
// //         .toString()
// //         .trim()
...
// // // Map known slugs to indices in features[]
// // // (edit this mapping if you add pages or want different icons)
// // const iconIndexBySlug = {
...
// //     team: 7, // GroupsIcon
// //     økonomi: 8,
// //     okonomi: 8, // alias without diacritics
// // };
...
// // // Get icon component from features[] using slug
// // function getIconFromFeatures(slug) {
// //     const n = norm(slug);
// //     const idx = iconIndexBySlug[n];
// //     if (Number.isInteger(idx) && features[idx]?.icon) return features[idx].icon;

// //     // Fallback: deterministic pick by hashing the slug
...
// //     // resolve Icon from slug every time slug changes
// //     const Icon = useMemo(() => getIconFromFeatures(slug), [slug]);
...
// //             {/* Uses icon derived from your features[] array */}
// //             <Box
// //                 sx={{
// //                     color: "primary.main",
...
// import { getIconFromSlug } from "../../data/featureIcons"; // ⬅️ NY

// export default function FeatureHeader({ docId, slug }) {
//     // Hent ikon fra slug via egen modul
...
import { getIconFromSlug } from "../../data/featureIcons"; // ✅ single source
